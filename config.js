export const SOURCES = [
    ...
    { key: 'vidzee', sourceFile: 'vidzee', label: 'VidZee', proxyParam: 'vz', timeout: 20000, jitter: 400, retries: 3, sourcesTimeout: 10000, disabled: true },
    ...
    { key: 'tryembed-sub', sourceFile: 'tryembed', label: 'TryEmbed (Sub)', proxyParam: 'tesub', timeout: 25000, jitter: 500, retries: 2, disabled: true },
    { key: 'tryembed-dub', sourceFile: 'tryembed', label: 'TryEmbed (Dub)', proxyParam: 'tedub', timeout: 25000, jitter: 500, retries: 2, disabled: true },

export const SOURCES = [
    ...
    { key: 'lookmovie', sourceFile: 'lookmovie', label: 'LookMovie', proxyParam: 'lm', timeout: 20000, jitter: 500, retries: 2, skipProxy: true },
    { key: 'tryembed-sub', sourceFile: 'tryembed', label: 'TryEmbed (Sub)', proxyParam: 'tesub', timeout: 25000, jitter: 500, retries: 2, skipCache: true, disabled: true },
    { key: 'tryembed-dub', sourceFile: 'tryembed', label: 'TryEmbed (Dub)', proxyParam: 'tedub', timeout: 25000, jitter: 500, retries: 2, skipCache: true, disabled: true },

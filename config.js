export const SOURCES = [
    { key: 'vidzee', sourceFile: 'vidzee', label: 'VidZee', proxyParam: 'vz', timeout: 15000, jitter: 400, retries: 3, sourcesTimeout: 5000 },
    { key: 'vidnest', sourceFile: 'vidnest', label: 'VidNest', proxyParam: 'vn', timeout: 20000, jitter: 600, retries: 3 },
    { key: 'vidsrc', sourceFile: 'vidsrc', label: 'VidSrc', proxyParam: 'vs', timeout: 25000, jitter: 700, retries: 2, sourcesTimeout: 5000 },
...
export const PROXY_LIST_URL = process.env.PROXY_LIST_URL || 'https://proxylist.geonode.com/api/proxy-list?limit=500&page=1&sort_by=lastChecked&sort_type=desc';
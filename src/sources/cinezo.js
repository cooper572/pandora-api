const SOURCES = [
    { name: 'nova', movieApi: 'https://test.tulnex.com/nova/movie/${id}', tvApi: 'https://test.tulnex.com/nova/tv/${id}/${s}/${e}' },
    { name: 'vaplayer', movieApi: 'https://test.tulnex.com/vaplayer/movie/${id}', tvApi: 'https://test.tulnex.com/vaplayer/tv/${id}/${s}/${e}' },
    { name: 'orion', movieApi: 'https://test.tulnex.com/orion/movie/${id}', tvApi: 'https://test.tulnex.com/orion/tv/${id}/${s}/${e}' },
    { name: 've-yoru', movieApi: 'https://test.tulnex.com/ve/server/Yoru/movie/${id}', tvApi: 'https://test.tulnex.com/ve/server/Yoru/tv/${id}/${s}/${e}' },
    { name: 'nhdapi', movieApi: 'https://test.tulnex.com/nhdapi/movie/${id}', tvApi: 'https://test.tulnex.com/nhdapi/tv/${id}/${s}/${e}' },
    { name: 'watchflix', movieApi: 'https://test.tulnex.com/watchflix/movie/${id}', tvApi: 'https://test.tulnex.com/watchflix/tv/${id}/${s}/${e}' },
    { name: '111movies-cobra', movieApi: 'https://test.tulnex.com/111movies/cobra/movie/${id}', tvApi: 'https://test.tulnex.com/111movies/cobra/tv/${id}/${s}/${e}' },
    { name: '111movies-bravo', movieApi: 'https://test.tulnex.com/111movies/Bravo/movie/${id}', tvApi: 'https://test.tulnex.com/111movies/Bravo/tv/${id}/${s}/${e}' },
    { name: 'youplex', movieApi: 'https://test.tulnex.com/youplex/movie/${id}', tvApi: 'https://test.tulnex.com/youplex/tv/${id}/${s}/${e}' },
    { name: '1shows', movieApi: 'https://test.tulnex.com/1shows/movie/${id}', tvApi: 'https://test.tulnex.com/1shows/tv/${id}/${s}/${e}' },
    { name: 've-neon', movieApi: 'https://test.tulnex.com/ve/server/Neon/movie/${id}', tvApi: 'https://test.tulnex.com/ve/server/Neon/tv/${id}/${s}/${e}' },
    { name: 'icefy', movieApi: 'https://test.tulnex.com/icefy/movie/${id}', tvApi: 'https://test.tulnex.com/icefy/tv/${id}/${s}/${e}' },
    { name: 'uniquestream', movieApi: 'https://test.tulnex.com/uniquestream/movie/${id}', tvApi: 'https://test.tulnex.com/uniquestream/tv/${id}/${s}/${e}' },
    { name: '111movies-alpha', movieApi: 'https://test.tulnex.com/111movies/Alpha/movie/${id}', tvApi: 'https://test.tulnex.com/111movies/Alpha/tv/${id}/${s}/${e}' },
    { name: 'fsharetv', movieApi: 'https://test.tulnex.com/fsharetv/movie/${id}', tvApi: '' },
    { name: 'flicky', movieApi: 'https://test.tulnex.com/flicky/movie/${id}', tvApi: 'https://test.tulnex.com/flicky/tv/${id}/${s}/${e}' },
    { name: 'v4', movieApi: 'https://test.tulnex.com/v4/movie/${id}', tvApi: 'https://test.tulnex.com/v4/tv/${id}/${s}/${e}' },
    { name: 'vidfast-vfast', movieApi: 'https://test.tulnex.com/vidfast/movie/vfast/${id}', tvApi: 'https://test.tulnex.com/vidfast/tv/vfast/${id}/${s}/${e}' },
    { name: 'moviebox', movieApi: 'https://test.tulnex.com/moviebox/movie/${id}', tvApi: 'https://test.tulnex.com/moviebox/tv/${id}/${s}/${e}' },
    { name: 'tik', movieApi: 'https://test.tulnex.com/tik/movie/${id}', tvApi: 'https://test.tulnex.com/tik/tv/${id}/${s}/${e}' },
    { name: 'vidzee', movieApi: 'https://test.tulnex.com/vidzee/movie/${id}?server=0', tvApi: 'https://test.tulnex.com/vidzee/tv/${id}/${s}/${e}?server=0' },
    { name: 'on', movieApi: 'https://test.tulnex.com/on/movie/${id}', tvApi: 'https://test.tulnex.com/on/tv/${id}/${s}/${e}' },
    { name: 'inka', movieApi: 'https://test.tulnex.com/inka/movie/${id}', tvApi: 'https://test.tulnex.com/inka/tv/${id}/${s}/${e}' },
    { name: 'vidfast-mega', movieApi: 'https://test.tulnex.com/vidfast/movie/Mega/${id}', tvApi: 'https://test.tulnex.com/vidfast/tv/Mega/${id}/${s}/${e}' },
    { name: 'vidfast-vrapid', movieApi: 'https://test.tulnex.com/vidfast/movie/VRapid/${id}', tvApi: 'https://test.tulnex.com/vidfast/tv/VRapid/${id}/${s}/${e}' },
    { name: 'vidfast-alpha', movieApi: 'https://test.tulnex.com/vidfast/movie/Alpha/${id}', tvApi: 'https://test.tulnex.com/vidfast/tv/Alpha/${id}/${s}/${e}' },
    { name: 'onion', movieApi: 'https://test.tulnex.com/onion/movie/${id}', tvApi: 'https://test.tulnex.com/onion/tv/${id}/${s}/${e}' },
    { name: 'vidlink', movieApi: 'https://test.tulnex.com/vidlink/movie/${id}', tvApi: 'https://test.tulnex.com/vidlink/tv/${id}/${s}/${e}' },
    { name: 'flaxmovies', movieApi: 'https://test.tulnex.com/flaxmovies/movie/${id}', tvApi: 'https://test.tulnex.com/flaxmovies/tv/${id}/${s}/${e}' },
